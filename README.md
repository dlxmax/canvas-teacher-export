...
Instructure is shutting down **Canvas Free For Teachers on May 29, 2026 11:59pm ET**. If you taught on a FFT account, every gradebook, discussion thread, assignment submission, file upload, page, and quiz you built lives behind that login until the lights go out. This tool gets it out as a human-readable, machine-parseable archive on your disk before that happens.
